...
public partial class Report_AadharCard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select * from AadharCardoutput where status='"+st+"' and type ='"+type+"'", cn);
        da.Fill(ds, "AadharCardoutput");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Report\AadharCard.rpt"));
