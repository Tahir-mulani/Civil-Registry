...
public partial class Customer_DeathReport : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from Deathcertificateoutput where type ='" + type + "' and name ='" + name + "'", cn);
        da.Fill(ds,"Deathcertificateoutput");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Report\Deathcertificateoutput.rpt"));
        crpt.SetDataSource(ds);
        CrystalReportViewer1.ReportSource = crpt;
        crpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Deathcertificateoutput");
        crpt.Refresh();
        cn.Close();
    }
}