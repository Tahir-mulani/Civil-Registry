...
public partial class Customer_VoterIdReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cn.Close();
        cn.Open();
        cmd.CommandText = "Select status from VoterId where name ='" + name + "'";
        cmd.Connection = cn;
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        ...
        string type = "Voter Id Card";
        cn.Open();
        SqlDataAdapter da = new SqlDataAdapter("select * from VoterIdCardoutput where type = '" + type + "' and name='" + name + "'", cn);
        da.Fill(ds, "VoterIdCardoutput");
        da.Fill(ds);
        crpt.Load(Server.MapPath(@"~\Report\VoterIdCardoutput.rpt"));
        crpt.SetDataSource(ds);
        CrystalReportViewer1.ReportSource = crpt;
        crpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "VoterIdCardoutput");
        crpt.Refresh();
        cn.Close();
    }
}